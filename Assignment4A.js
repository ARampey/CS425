var PA4A = {
    ...
    onClick: function() {
     ...
     /*   var x = document.getElementById("myTable");
        ...
        cell.innerHTML = "This is table header";
       ...
       for (var h = 0; h < data.length; h++) {
             ...
             this.headers = this.fields[h];
             //console.log(this.headers);
               
             //var row = header.insertRow(h);
       }
            
        //var headers = JSON.parse(this.fields);
        ...
        // add to table; then add to "output"
        
        //for (var n = 0; n < fields.length; )    
      ...
      for (var i = 0; i < data.length; i++) {
              ...
              document.write(address.firstname, address.middleinitial, address.lastname);
             // console.log(address.address);
             // document.write(address.city + ", " + address.state + " " + address.zip);
              document.write("");
      }
